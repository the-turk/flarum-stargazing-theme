...
/* harmony import */ var _modals_StargazingSettingsModal__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modals/StargazingSettingsModal */ "./src/admin/modals/StargazingSettingsModal.js");

 // initialize settings modal

flarum_app__WEBPACK_IMPORTED_MODULE_0___default.a.initializers.add('the-turk-stargazing-theme', function (app) {
  app.extensionSettings['the-turk-stargazing-theme'] = function () {
    return app.modal.show(new _modals_StargazingSettingsModal__WEBPACK_IMPORTED_MODULE_1__["default"]());
  };
});

/***/ }),

/***/ "./src/admin/modals/StargazingSettingsModal.js":
/*!*****************************************************!*\
  !*** ./src/admin/modals/StargazingSettingsModal.js ***!
  \*****************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return StargazingSettingsModal; });
...
var settingsPrefix = 'the-turk-stargazing-theme.';
var translationPrefix = 'the-turk-stargazing-theme.admin.settings.';

var StargazingSettingsModal =
/*#__PURE__*/
function (_SettingsModal) {
  Object(_babel_runtime_helpers_esm_inheritsLoose__WEBPACK_IMPORTED_MODULE_0__["default"])(StargazingSettingsModal, _SettingsModal);

  function StargazingSettingsModal() {
    return _SettingsModal.apply(this, arguments) || this;
  }

  var _proto = StargazingSettingsModal.prototype;
  ...
  _proto.form = function form() {
    ...
    return [m('.Form-group', [m('label', flarum_components_Switch__WEBPACK_IMPORTED_MODULE_3___default.a.component({
      ...
      children: flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans(translationPrefix + 'relocateSidebar'),
      onchange: function onchange(value) {
        _this.setting(settingsPrefix + 'relocateSidebar')(value ? '1' : '0');
      }
      ...
      children: flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans(translationPrefix + 'enableStarsBackground'),
      onchange: function onchange(value) {
        _this.setting(settingsPrefix + 'enableStarsBackground')(value ? '1' : '0');
      }
    }))])];
  };

  return StargazingSettingsModal;
